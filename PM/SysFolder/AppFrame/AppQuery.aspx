<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppQuery.aspx.cs" Inherits="EIS.Web.SysFolder.AppFrame.AppQuery" %>
...
<!--
    var _curClass = EIS.Web.SysFolder.AppFrame.AppQuery;
    var para="";
    $(function(){
    });
    $("#flex1").flexigrid({
        ...
        function app_export(cmd,grid)
        {
            ...
            function app_setquery()
            {
                ...
                paraStr = _curClass.CryptPara(paraStr).value;
                openCenter("AppConditionDef.aspx?para="+paraStr,"_blank",400,500);
			}
			function app_query()
			{
			    $("#flex1").flexReload();
