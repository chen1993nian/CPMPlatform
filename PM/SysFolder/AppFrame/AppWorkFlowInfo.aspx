<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppWorkFlowInfo.aspx.cs" Inherits="EIS.Web.SysFolder.AppFrame.AppWorkFlowInfo" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function appPrint() {
            $("#divAppTableHtml,.wfdealinfo").jqprint({
                importCSS: true,
                printContainer: true
            });
        }
