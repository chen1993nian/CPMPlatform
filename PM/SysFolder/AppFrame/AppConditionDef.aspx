<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppConditionDef.aspx.cs" Inherits="EIS.Web.SysFolder.AppFrame.AppConditionDef" %>
	...
	#maindiv{overflow:auto;}
		...
		<script type="text/javascript">
		    ...
		    function save() {
		        ...
		        var ret = EIS.Web.SysFolder.AppFrame.AppConditionDef.saveQuery(querylist, "<%=tblName %>", "<%=sindex %>");
        if (ret.error) {
