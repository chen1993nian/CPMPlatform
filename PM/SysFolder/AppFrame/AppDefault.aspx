<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppDefault.aspx.cs" Inherits="EIS.Web.SysFolder.AppFrame.AppDefault" %>
...
<!--
    var _curClass = EIS.Web.SysFolder.AppFrame.AppDefault;
    ...
    function app_detail(autoid)
    {
        ...
        var url="AppDetail.aspx?para="+_curClass.CryptPara(paraStr).value;
        ...
        //});
        //dlg.ShowDialog();
        //app_showHelp(url, "<%=TblNameCn %>");
        openCenter(url,"_blank",wwh,whe);
    }
