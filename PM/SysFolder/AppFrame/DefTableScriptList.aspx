<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefTableScriptList.aspx.cs" Inherits="EIS.Web.SysFolder.AppFrame.DefTableScriptList2" %>
...
<!--
    var _curClass =EIS.Web.SysFolder.AppFrame.DefTableScriptList2;
    var para="";
    $(function(){
	...
	({
	    ...
	    params:[{name:"queryid",value:"T_E_Sys_TableScript"}
			    ...
			    ,{name:"condition",value:"TableName='<%=Request["bizName"]%>'"}
	    ],
	    colModel : [
    ...
    {
        para="para="+_curClass.CryptPara("TblName=T_E_Sys_TableScript&T_E_Sys_TableScriptcpro=TableName=<%=Request["bizName"]%>^1&sindex=<%=sindex %>&condition=").value;
