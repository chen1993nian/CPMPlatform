<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlowShareTo.aspx.cs" Inherits="EIS.Web.SysFolder.WorkFlow.FlowShareTo" %>
...
<body>
    ...
    <div id="maindiv" style="width:500px;">
        ...
        <div style="text-align:left;position:relative;">
           ...
           <asp:TextBox Rows="30" TextMode="MultiLine"  CssClass="TextBoxInArea"  Width="98%" ID="txtReason" runat="server"></asp:TextBox>
