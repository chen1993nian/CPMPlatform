...
{
    /// <summary>
    /// GetWorkflowImg1 的摘要说明
    /// </summary>
    public class GetWorkflowImg1 : IHttpHandler
    {
        private int int_0 = 0;
        private int int_1 = 0;
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            this.workflowId = context.Request["workflowId"].ToString();
            ...
            this.int_0 = this.int_0 + 60;
            this.int_1 = this.int_1 + 60;
            ...
            foreach (Activity activity1 in workflowProcessById.GetActivities().GetActivities())
            {
                ...
                image = Image.FromFile(string.Concat(EIS.AppBase.Utility.GetPhysicalRootPath(), "\\Img\\Workflow\\", str));
