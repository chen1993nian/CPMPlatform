<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Finish.aspx.cs" Inherits="EIS.Web.SysFolder.WorkFlow.Admin_Finish" %>
...
<!--
    ...
    var _curClass = EIS.Web.SysFolder.WorkFlow.Admin_Finish;
    $("#flex1").flexigrid
    (
    {
        url: '../../getdata.ashx',
