<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlowList.aspx.cs" Inherits="EIS.Web.SysFolder.WorkFlow.FlowList" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    ...
	    function newflow(wfid, tblname) {
	        //获得窗口的垂直位置 
	        var iHeight =window.screen.availHeight - 250;
	        //获得窗口的水平位置 
	        var iLeft = (window.screen.availWidth - 10 - 1024) / 2;
	        window.open("Newflow.aspx?workflowid=" + wfid, "_blank", "scrollbars=yes;top=0px,left=" + iLeft, "width=1024,height=" + iHeight, "resizable=yes");
 
	    }
	    function openchart(wfid) {
	        window.open('FlowChart.aspx?workflowid=' + wfid, '_blank', 'scrollbars=yes;top=0,left=0,width=1024,height=750,resizable=yes');
	    }
	</script>
</head>
<body scroll="auto">
