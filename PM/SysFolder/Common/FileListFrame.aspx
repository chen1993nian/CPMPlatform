<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileListFrame.aspx.cs" Inherits="EIS.Web.SysFolder.Common.FileListFrame" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function copyFiles(arrFileId) {
            var ret = EIS.Web.SysFolder.Common.FileListFrame.CopyFiles(arrFileId.join(","),"<%=appId %>","<%=appName %>");
            if (ret.error) {
                alert(ret.error.Message);
            }
            else {
