<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserTree.aspx.cs" Inherits="EIS.Web.SysFolder.Common.UserTree" %>
...
<script type="text/javascript" src="../../js/jquery.zxxbox.3.0-min.js"></script>
    ...
    <script type="text/javascript">
        var _curClass = EIS.Web.SysFolder.Common.UserTree;
