<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefExcludeLimitLeft.aspx.cs" Inherits="EIS.Web.SysFolder.Permission.DefExcludeLimitLeft" %>
...
<!--
    ...
    function transName(v, row) {
        ...
        return "<a href=\"DefExcludeLimitEdit.aspx?roleId=" + empId + "&rolename=" + empName + "\" target='main'>" + v + "</a>";
    }
    function app_select() {
