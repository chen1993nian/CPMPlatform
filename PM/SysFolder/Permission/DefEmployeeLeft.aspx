<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefEmployeeLeft.aspx.cs" Inherits="EIS.Web.SysFolder.Permission.DefEmployeeLeft" %>
        ...
        <ul id="tree"  class="ztree"> 
          ...
          <script type="text/javascript">
              ...
              function nodeClick(e,treeId,node)
              {
                  ...
                  {
                      window.parent.frames["main"].location = "CompanyEmployeeList.aspx?DeptID="+node.value+"&Condition=DeptID in ( select _autoid from t_e_org_department where deptwbs like '"+node.id+"%')"; 

                  }
                  else
                  {
                      window.parent.frames["main"].location = "CompanyEmployeeList.aspx?DeptID="+node.value+"&Condition=DeptID='"+node.value+"'"; 
                  }
                  return;
                  window.open("DefPositionList.aspx?DeptID="+item.value+"&condition=DeptID='"+node.value+"'" ,"main");
