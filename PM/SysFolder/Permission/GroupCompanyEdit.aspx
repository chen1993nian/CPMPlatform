<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupCompanyEdit.aspx.cs" Inherits="EIS.Web.SysFolder.Permission.GroupCompanyEdit" %>
...
<body>
    ...
    <tr>
      ...
      <tr style="display:none;">
        <td>&nbsp;目录服务路径</td>
        <td>
            <asp:TextBox ID="txtPath" CssClass="TextBoxInChar" runat="server" v></asp:TextBox>
