<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefPositionLimitEdit.aspx.cs" Inherits="EIS.Web.SysFolder.Permission.DefPositionLimitEdit" %>
...
<body>
    <form id="form1" runat="server">   
            ...
            <div class="topnav">
                ...
                <span style="float:right;margin-right:20px">
                    ...
                    &nbsp;&nbsp;
                        <a id="A3" href="javascript:SaveRoleLimit();"  title="保存该岗位权限">保存</a>
                    &nbsp;&nbsp;
                        <a class="winHelpLinkBtn" data-hlpUrl="Help/HelpLimite.aspx#a2" data-hlpTitle="岗位授权帮助" href="javascript:void(0);">帮助</a>
                    &nbsp;&nbsp;
                 </span>       
            </div>
            </div>
	...
	<script type="text/javascript">
	    var _curClass = EIS.Web.SysFolder.Permission.DefPositionLimitEdit;
