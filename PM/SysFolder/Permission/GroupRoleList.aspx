<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupRoleList.aspx.cs" Inherits="EIS.Web.SysFolder.Permission.GroupRoleList" %>
...
<!--
    var curClass = EIS.Web.SysFolder.Permission.GroupRoleList;
    var para = "";
    $(function () {
    });
    $("#flex1").flexigrid
