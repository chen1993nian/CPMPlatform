<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefFunNodeLeft.aspx.cs" Inherits="EIS.Web.SysFolder.Permission.DefFunNodeLeft" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        var _curClass = EIS.Web.SysFolder.Permission.DefFunNodeLeft;
        var setting = { 
            edit: {
                drag:{
        ...
        function nodeClick(e,treeId,node)
        {
            if(!chkLimit)
            {
                window.open("../../SysFolder/AppFrame/AppInput.aspx?tblName=T_E_Sys_FunNode&condition=_AutoID='"+node.value+"'","main");
            }
            else
            {
                window.open("../Limit/ObjectLimitFrame.aspx?funId="+node.value,"main");
            }
        }
