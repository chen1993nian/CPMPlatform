<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupCompanyList.aspx.cs" Inherits="EIS.Web.SysFolder.Permission.GroupCompanyList" %>
...
<!--
    var curClass = EIS.Web.SysFolder.Permission.GroupCompanyList;
    var para = "";
    $(function () {
    });
    $("#flex1").flexigrid
