<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QueryEmployeeLimit.aspx.cs" Inherits="EIS.Web.SysFolder.Permission.QueryEmployeeLimit" %>
    ...
    <form id="form1" runat="server">   
            ...
            <div class="topnav">
                ...
                <span style="float:right;margin-right:10px">
                    ...
                    &nbsp;&nbsp;
                        <a class="winHelpLinkBtn" data-hlpUrl="Help/HelpLimite.aspx#a6" data-hlpTitle="查询授权帮助" href="javascript:void(0);">帮助</a>
                    &nbsp;&nbsp;
                 </span>       
            </div>
            </div>
