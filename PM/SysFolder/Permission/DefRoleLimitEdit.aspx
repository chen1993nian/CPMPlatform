<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefRoleLimitEdit.aspx.cs" Inherits="EIS.Web.SysFolder.Permission.DefRoleLimitEdit" %>
    ...
    <form id="form1" runat="server">   
            ...
            <div class="topnav">
                ...
                <span style="float:right;margin-right:10px">
                    ...
                    &nbsp;&nbsp;
                        <a class="winHelpLinkBtn" data-hlpUrl="Help/HelpLimite.aspx#a4" data-hlpTitle="角色授权帮助" href="javascript:void(0);">帮助</a>
                    &nbsp;&nbsp;
                 </span>       
            </div>
            </div>
...
<script type="text/javascript">
    var _curClass = EIS.Web.SysFolder.Permission.DefRoleLimitEdit;
