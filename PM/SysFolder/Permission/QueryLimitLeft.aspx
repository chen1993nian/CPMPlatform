<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QueryLimitLeft.aspx.cs" Inherits="EIS.Web.SysFolder.Permission.QueryLimitLeft" %>
...
<!--
    ...
    function transName(v, row) {
        ...
        return "<a href=\"QueryEmployeeLimit.aspx?roleId=" + empId + "&rolename=" + empName + "\" target='main'>" + v + "</a>";
    }
    function app_select() {
