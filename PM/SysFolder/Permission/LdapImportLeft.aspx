<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LdapImportLeft.aspx.cs" Inherits="EIS.Web.SysFolder.Permission.LdapImportLeft" %>
            ...
            var o = {
                ...
                onnodeclick: function (item) {
                    ...
                    if (item.id.length == 36)
                        window.parent.frames["main"].setPos(item.id, item.text);
