<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefPositionLeft.aspx.cs" Inherits="EIS.Web.SysFolder.Permission.DefPositionLeft" %>
	...
	<body>
        ...
        <ul id="tree"  class="ztree"> 
          ...
          <script type="text/javascript">
              ...
              {
                  window.parent.frames["main"].location.href="DefPositionList.aspx?DeptID="+node.value+"&condition=DeptID='"+node.value+"'"; 
