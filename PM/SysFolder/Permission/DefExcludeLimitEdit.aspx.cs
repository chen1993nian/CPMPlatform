...
{
    public partial class DefExcludeLimitEdit : AdminPageBase
    {
        ...
        protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            this.dataTable_0 = ExcludeLimitService.GetExcludeLimitDataById(this.webId, this.roleid);
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(DefExcludeLimitEdit));
        ...
        {
            this.dataTable_0 = ExcludeLimitService.GetExcludeLimitDataById(webId, roleid);
            ...
            try
            {
                foreach (XmlNode xmlNodes in xmlDocument.SelectNodes("//tn[@EditFlag='1']"))
                {
                    ...
                    {
                        strArrays = new string[] { "update dbo.T_E_Org_ExcludeLimit set Limit ='", value1, "',funwbs='", value, "' where funid='", str1, "' and EmployeeID='", roleid, "'" };
