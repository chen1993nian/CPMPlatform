...
namespace EIS.Web.Doc
{
    ...
    /// GetListNew 的摘要说明
    /// </summary>
    public class GetListNew : IHttpHandler, IRequiresSessionState
    {
       ...
       private readonly static string string_0;
        ...
        static GetListNew()
        {
            GetListNew.string_0 = Guid.NewGuid().ToString();
        }
        ...
        private void method_0()
        {
          ...
          //  string str1 = HttpContext.Current.Session["EmployeeId"].ToString();
            string str1 = System.Configuration.ConfigurationManager.AppSettings["EmployeeId"].ToString();
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string str = System.Configuration.ConfigurationManager.AppSettings["UserName"].ToString();
            ...
            if (HttpContext.Current.Cache[GetListNew.string_0] == null)
            {
                xmlDocument.Load(str1);
                CacheDependency cacheDependency = new CacheDependency(str1);
                HttpRuntime.Cache.Insert(GetListNew.string_0, xmlDocument, cacheDependency);
            }
            else
            {
                xmlDocument = HttpContext.Current.Cache[GetListNew.string_0] as XmlDocument;
            }
