<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectDataLimitProjectList.aspx.cs"
    Inherits="EIS.WorkAsp.DataLimit.ProjectDataLimitProjectList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $("document").ready(function () {
            $('#flexme1').flexigrid({
                url: 'ProjectDataLimitProjectListXML.aspx',
                ...
                , { display: '工程名称', name: 'projectname', width: 80, sortable: true, align: 'left', hide: false, renderer: false, fieldid: '7619fa25-9bcf-4220-8d16-b3d3a576ac57' }
                , { display: '工程编号', name: 'projectcode', width: 80, sortable: true, align: 'left', hide: false, renderer: false, fieldid: 'bb4c7057-e2b3-4688-b2bb-95cf5430457c' }
                ...
                , { display: '所属经济片区', name: 'RegionName', width: 80, sortable: true, align: 'left', hide: false, renderer: false, fieldid: '4925b6c9-52db-43a3-830e-66efa7516975' }
    ...
    function colLimit(fldval, row) {
         var ProjectID = row.selectNodes("projectid")[0].text;
         var projectname = row.selectNodes("projectname")[0].text;
     ...
     function ChangeProjectLimit(projectname, projectid, objchk) {
         ...
         var rest = EIS.WorkAsp.DataLimit.ProjectDataLimitProjectList.SaveCheckProject(fldname, fldvalue, projectid, IsChecked).value;
         if (objchk.checked)
