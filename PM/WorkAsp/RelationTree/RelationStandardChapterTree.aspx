<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelationStandardChapterTree.aspx.cs" Inherits="EIS.WorkAsp.RelationTree.RelationStandardChapterTree" %>
...
<body style="margin:0;" scroll="auto"  oncontextmenu="return(false);">
    <form id="form1" runat="server">
         <table  width="100%"  height="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td><%=Request["StandardName"].ToString()%></td>
            </tr>
			<tr>
				<td valign="top">
