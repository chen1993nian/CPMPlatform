<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportDataTJJGZB2DemoField1.aspx.cs" Inherits="EIS.Web.ImportDataTJJGZB.ImportDataTJJGZB2DemoField1" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function OpenDataView() {
            var url = "ImportDataTJJGZB2DemoField3.aspx?TableName=<%=TableName %>";
