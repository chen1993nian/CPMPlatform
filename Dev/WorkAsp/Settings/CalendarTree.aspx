<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalendarTree.aspx.cs" Inherits="EIS.WebBase.WorkAsp.Settings.CalendarTree" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        {
            if(node.id!="root"){
                window.open("SetCalendar.aspx?nodeId=" + node.id + "&time=" + Math.random(), "calMain");
            }
        }
        ...
        var _curClass = EIS.WebBase.WorkAsp.Settings.CalendarTree;
