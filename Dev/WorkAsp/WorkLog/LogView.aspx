<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogView.aspx.cs" Inherits="EIS.Web.WorkAsp.WorkLog.LogView" %>
...
<body>
    ...
    <div class="toolbar" style="">
        <div style="float:left;">
            <a href="javascript:" class="subtitle">[ <b class="green"><%=EmpName %></b> ]&nbsp;的工作日志</a>
            &nbsp;
...
<script type="text/javascript">
    $(function () {
        ...
        $("#btnNew").click(function () {
            window.open("../../SysFolder/AppFrame/AppInput.aspx?tblName=T_OA_WorkLog", "_self");
        });
