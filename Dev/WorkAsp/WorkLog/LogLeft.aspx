<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogLeft.aspx.cs" Inherits="EIS.Web.WorkAsp.WorkLog.LogLeft" %>
...
<head id="Head1" runat="server">
	...
	<body>
		<form id="Form1" method="post" runat="server">
         <div class="toolbar" style="">
            ...
            &nbsp;
            <button id="btnView" type="button" title="我的工作日志"><img alt="我的工作日志" src="../../img/common/calendar0.png" />我的工作日志</button>
    ...
    <script type="text/javascript">
        ...
        {
            if(node.value=="1")
                window.open("LogView.aspx?empId=" + node.id + "&time=" + Math.random(), "logmain");
        }
        ...
        $(function () {
            ...
            $("#btnView").click(function(){
                window.open("LogRight.aspx?time=" + Math.random(), "logmain");
            });
