<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefEmployeeLimitLeft.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.DefEmployeeLimitLeft" %>
...
<!--
    ...
    function transName(v, row) {
        ...
        return "<a href=\"DefEmployeeLimitEdit.aspx?roleId=" + empId + "&rolename=" + empName + "\" target='DefEmpLimMain'>" + v + "</a>";
    }
    function app_select() {
