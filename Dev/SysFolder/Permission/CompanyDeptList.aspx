<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyDeptList.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.CompanyDeptList" %>
...
<!--
    var curClass = EIS.Studio.SysFolder.Permission.CompanyDeptList;
    var para = "";
    $(function () {
    });
    $("#flex1").flexigrid
