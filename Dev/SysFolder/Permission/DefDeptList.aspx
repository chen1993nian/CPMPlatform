<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefDeptList.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.DefDeptList" %>
...
<!--
    var curClass = EIS.Studio.SysFolder.Permission.DefDeptList;
    var para = "";
    $(function () {
    });
    $("#flex1").flexigrid
