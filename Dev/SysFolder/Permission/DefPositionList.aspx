<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefPositionList.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.DefPositionList" %>
...
<!--
    var curClass = EIS.Studio.SysFolder.Permission.DefPositionList;
    var para = "";
    $(function () {
    });
    $("#flex1").flexigrid
			...
			{ display: '序号', name: 'rowindex', width: 30, sortable: false, align: 'center' },
                ...
                function app_help() {
                    app_showHelp("Help/HelpGroupCompanyList.aspx#a5", "岗位信息设置帮助");
                }
