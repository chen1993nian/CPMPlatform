<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupPublicList.aspx.cs" Inherits="Studio.JZY.SysFolder.Permission.GroupPublicList" %>
...
<!--
    var curClass = Studio.JZY.SysFolder.Permission.GroupPublicList;
    var para = "";
    $(function () {
    });
    $("#flex1").flexigrid
    ...
    function app_help() {
        app_showHelp("Help/HelpGroupCompanyList.aspx#a7", "员工分组帮助");
    }
