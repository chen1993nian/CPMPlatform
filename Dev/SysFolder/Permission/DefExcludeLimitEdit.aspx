<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefExcludeLimitEdit.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.DefExcludeLimitEdit" %>
    ...
    <form id="form1" runat="server">   
            ...
            <div class="topnav">
                ...
                <span style="float:right;margin-right:10px">
                        ...
                        <a class="winHelp" data-hlpUrl="Help/HelpLimite.aspx#a5" href="javascript:void(0);">帮助</a>
                    &nbsp;&nbsp;
...
<script type="text/javascript">
    var _curClass = EIS.Studio.SysFolder.Permission.DefExcludeLimitEdit;
