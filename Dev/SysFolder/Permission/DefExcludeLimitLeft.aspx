<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefExcludeLimitLeft.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.DefExcludeLimitLeft" %>
...
<!--
    ...
    function transName(v, row) {
        ...
        return "<a href=\"DefExcludeLimitEdit.aspx?roleId=" + empId + "&rolename=" + empName + "\" target='DefExcLimMain'>" + v + "</a>";
    }
    function app_select() {
