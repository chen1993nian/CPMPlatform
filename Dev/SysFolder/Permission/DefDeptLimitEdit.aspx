<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefDeptLimitEdit.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.DefDeptLimitEdit" %>
    ...
    <form id="form1" runat="server">   
            ...
            <div class="topnav">
                ...
                <span style="float:right;margin-right:20px">
                        ...
                        <a class="winHelp" data-hlpUrl="Help/HelpLimite.aspx#a1" href="javascript:void(0);">帮助</a>
                    &nbsp;&nbsp;
...
<script type="text/javascript">
    var _curClass = EIS.Studio.SysFolder.Permission.DefDeptLimitEdit;
