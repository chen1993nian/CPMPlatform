<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefDeptLimitLeft.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.DefDeptLimitLeft" %>
        ...
        <ul id="tree"  class="ztree"> 
          ...
          <script type="text/javascript">
              ...
              function nodeClick(e,treeId,node)
              {
                  ...
                  var d=new Date();
                  window.open("DefDeptLimitEdit.aspx?roleId="+node.value+ "&rolename="+escape(node.name)+"&t="+d.getMilliseconds(),"DefDeptLimtMain");
