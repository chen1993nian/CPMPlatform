<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefFunNodeList.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.DefFunNodeList" %>
...
<!--
    var AppDefault = EIS.Studio.SysFolder.Permission.DefFunNodeList;
    var para = "";
    $(function () {
    });
    $("#flex1").flexigrid
