<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefPositionLeft.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.DefPositionLeft" %>
	...
	<body>
        ...
        <ul id="tree"  class="ztree"> 
          ...
          <script type="text/javascript">
              ...
              {
                  window.open("DefPositionList.aspx?DeptID="+node.value+"&condition=DeptID='"+node.value+"'","DefPosMain"); 
