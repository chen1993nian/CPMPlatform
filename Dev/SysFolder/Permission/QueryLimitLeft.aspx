<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QueryLimitLeft.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.QueryLimitLeft" %>
...
<!--
    ...
    function transName(v, row) {
        ...
        return "<a href=\"QueryEmployeeLimit.aspx?roleId=" + empId + "&rolename=" + empName + "\" target='QueryLimMain'>" + v + "</a>";
    }
    function app_select() {
