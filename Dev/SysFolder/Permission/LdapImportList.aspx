<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LdapImportList.aspx.cs" Inherits="Studio.JZY.SysFolder.Permission.LdapImportList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
<!--
        var _curClass = Studio.JZY.SysFolder.Permission.LdapImportList;
