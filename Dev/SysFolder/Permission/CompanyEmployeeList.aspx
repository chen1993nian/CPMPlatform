<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyEmployeeList.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.CompanyEmployeeList" %>
...
<!--
    var AppDefault = EIS.Studio.SysFolder.Permission.CompanyEmployeeList;
    var para = "";
    $(function () {
    });
    $("#flex1").flexigrid
    ...
    function app_help() {
        app_showHelp("Help/HelpGroupCompanyList.aspx#a6", "员工信息设置帮助");
    }
