...
{
    public partial class OrgIO_DeptImport : AdminPageBase
    {
        ...
        {
            AppFile lastFileByAppId = FileService.GetLastFileByAppId("OrgIO_DeptImport");
            ...
            else
            {
                ...
                if (File.Exists(string.Concat(basePath, lastFileByAppId.FilePath)))
                {
                    ...
                    stringBuilder.Append(OrgIO.OrgImport(dataTable));
                    ...
                    for (int i = 0; i < (int)dataRowArray.Length; i++)
                    {
                        ...
                        string str3 = dataRow[2].ToString();
                        stringBuilder.AppendFormat("\r{0}\t{1}（{2}）", str1, str2, str3);
                    }
