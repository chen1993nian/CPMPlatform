<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PositionMoveList.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.PositionMoveList" %>
...
<!--
    var AppDefault = EIS.Studio.SysFolder.Permission.PositionMoveList;
    var para = "";
    $(function () {
    });
    $("#flex1").flexigrid
    ...
    function roleSet(empId) {
        ...
        */
        var chg_url = "./WorkAsp/Permission/ChangeEmployeePosition.aspx?employeeId=" + empId;
        var chg_win = new $.dialog({
            id: 'chgPosition', cancelBtn: false, maxBtn: false
            , title: '调整岗位'
            , autoSize: false, width: 1024, height: 600
            , cover: true, bgcolor: '#000', opacity: 0.2
            , page: chg_url
        });
        chg_win.ShowDialog();
    }
    ...
    function app_help() {
        app_showHelp("Help/HelpGroupCompanyList.aspx#a11", "员工分组帮助");
    }
