<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupEmployeeRoleSet.aspx.cs" Inherits="Studio.JZY.SysFolder.Permission.GroupEmployeeRoleSet" %>
    ...
    <script type="text/javascript">
        ...
        function load() {
            ...
            $("#btnconfirm").click(function (e) {
                ...
                var r = Studio.JZY.SysFolder.Permission.GroupEmployeeRoleSet.SaveRoleSet(emps.join(","), "<%=roleId %>");
              if (r.error) {
