<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupEmployeeRoleList.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.GroupEmployeeRoleList" %>
...
<!--
    var AppDefault = EIS.Studio.SysFolder.Permission.GroupEmployeeRoleList;
    var para = "";
    $(function () {
    });
    $("#flex1").flexigrid
    ...
    function app_help() {
        app_showHelp("Help/HelpGroupCompanyList.aspx#a9", "员工分组帮助");
    }
