<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrgIO_EmpImport.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.OrgIO_EmpImport" %>
...
<body>
    ...
    <div id="maindiv" style="text-align:center;padding-top:40px;margin-left:auto;margin-right:auto;">
        <table align="center" style="text-align:left;">
            <caption style="font:bold 12pt/200% 'Microsoft YaHei';border-bottom:2px solid #3598db;padding-bottom:10px;">人员岗位导入</caption>
            <tr>
                <td style="width:60px;" valign="top">
                    <span class="step">步骤1、</span>
                </td>
                <td style="line-height:180%;font-size:11pt;"> 
                    下载人员岗位模板文件，按照模板内要求，整理人员岗位数据。点击后面链接下载模板
                    <a href="tmpl/02.岗位人员.xls" target="_blank">【岗位人员.xls】</a>
            ...
            <tr>
                ...
                <td style="line-height:180%;font-size:11pt;">点击下面的【选择文件】，上传整理好的数据文件（目前只接收.xls格式，高版本的Excel文件选择另存为.xls）
                    ...
                    src="../Common/FileListFrame.aspx?set=*.xls||0&appName=OrgIO_EmpImport&appId=OrgIO_EmpImport&read=0&fromDoc=0" width="100%" height="80px">
                    </iframe>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <asp:Button ID="Button1" runat="server" Text="开始导入" onclick="Button1_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckBox1" runat="server" Text="导入之前清空所有人员岗位数据" />
                    <div class="tip">说明：如果需要重新导入，请选择【导入之前清空所有人员岗位数据】，否则不要勾选。</div>
                    <div>
