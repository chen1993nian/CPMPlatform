<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefDeptEdit.aspx.cs" Inherits="EIS.Studio.SysFolder.Permission.DefDeptEdit" %>
...
<head>
    ...
    <style type="text/css">
        ...
        .winHelp {
    		background: url(../../Help/Imgs/help1.png) no-repeat center left transparent;
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btnSave").click(function () {
                ...
                window.parent.frames["DefDeptLeft"].nodeNameChange(deptName);
...
<body>
    ...
    <div class="menubar">
        <div class="topnav" style="line-height:26px;text-align:right;padding-right:60px;">
            ...
            <a class="winHelp" data-hlpUrl="Help/HelpGroupCompanyList.aspx#a4" href="#">帮助</a>
        </div>
    </div>
