<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlowChart.aspx.cs" Inherits="EIS.WebBase.SysFolder.WorkFlow.FlowChart" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <tr><td style="color:Gray;font-size:11px;">创建人：<%=Creator%> &nbsp;&nbsp;&nbsp;&nbsp;版本：<%=defModel.Version%>&nbsp;&nbsp;&nbsp;&nbsp;创建时间：<%=defModel._CreateTime%></td></tr>
    </table>
