<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Company_Watch.aspx.cs" Inherits="EIS.WebBase.SysFolder.WorkFlow.Company_Watch" %>
...
<head id="Head1" runat="server">
    ...
    input[name='EmployeeName']{width:60px;}
    </style>
</head>
    ...
    (
    {
        ...
        params: [{ name: "queryid", value: "flow_company_watch" }
            , { name: "condition", value: "CompanyId in (select companyId from T_E_Org_DeptEmployee de where de._isdel=0 and  de.employeeId='<%=base.EmployeeID %>')" }
                ...
                { display: '达到天数', name: 'ArriveDays', width: 60, sortable: true, align: 'left' },
		        ...
		        { display: '达到天数', name: 'ArriveDays', type: 2 }
			    ],
