<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealFlow.aspx.cs" Inherits="EIS.WebBase.SysFolder.WorkFlow.DealFlow" %>
        ...
        <div class="wfdealinfo" style="text-align:left;">
           ...
           <div style="margin-top:15px;border:1px solid #ddd;padding:2px;text-align:right;height:30px;line-height:30px;background:#fbfbfb;">
                <span style="float:left;">
					...
					<asp:Button ID="btnReject"  CssClass="btn01" runat="server" Text="不同意" onclick="btnReject_Click"/>
    ...
    <script type="text/javascript">
        ...
        jQuery(function($){
            ...
            $("#btnSubmit").click(function(){
                if(!confirm("您确定选择【"+jQuery(event.srcElement).val()+"】吗？"))
                    return false;
                _saveAction = "1";
                if(_saveBeforeSubmit)
                    return _sysSave();
        ...
        var _curClass =EIS.WebBase.SysFolder.WorkFlow.DealFlow;
        var _isNew = false;
