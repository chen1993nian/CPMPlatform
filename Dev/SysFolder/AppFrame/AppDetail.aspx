<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppDetail.aspx.cs" Inherits="EIS.WebBase.SysFolder.AppFrame.AppDetail" %>
...
<head id="Head1" runat="server">
    ...
    <script src="AppDetail.js" type="text/javascript"></script>
</head>
<body scroll="auto">
    ...
    <% =tblHTML%>
        ...
        <div class="ccomment">
            ...
            <div class="cwrite">
                <h4>我来说两句</h4>
                <textarea  id="txtCommentContent" rows="10" ></textarea>
