...
{
    public partial class FunLimitQuery : AdminPageBase
    {
        ...
        public string GetListTree(string PIDValue, string Indent)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                stringBuilder.Append(indent);
                stringBuilder.AppendFormat("<a href='../Common/userInfo.aspx?empId={1}' target='_blank'>{0}</a></td>", string.Concat(str1, "（", str4, "）"), str2);
