...
{
    public partial class FunLimitEmployee : AdminPageBase
    {
        public string funId = "";
        ...
        public string SaveLimit(string funId, string limitxml)
        {
            ...
            try
            {
                ...
                foreach (XmlNode xmlNodes in xmlDocument.SelectNodes("//tn[@EditFlag='1']"))
                {
                    ...
                    {
                        strArrays = new string[] { "update dbo.T_E_Org_EmployeeLimit set Limit ='", value, "',funwbs='", funWbsById, "' where funid='", funId, "' and employeeId='", value1, "'" };
