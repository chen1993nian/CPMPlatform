<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PositionTree_Relation.aspx.cs" Inherits="EIS.Studio.SysFolder.DefFrame.inc.PositionTree_Relation" %>
...
<head id="Head1" runat="server">
	...
	function save()
	{
	   ...
	   var querylist= $('#querysel').sortable('toArray');
        ...
        parent.frameElement.lhgDG.curWin.styleCallBack("<%=key %>:弹出岗位树:|" + tablelist.join(",") + "|" + querylist.join(","));
