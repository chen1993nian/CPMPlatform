...
{
    public partial class DefTableScriptList : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            AjaxPro.Utility.RegisterTypeForAjax(typeof(DefTableScriptList));
            StringBuilder stringBuilder = new StringBuilder();
            ...
            this.bizName = base.GetParaValue("bizName");
            if (this.addBtnText == "")
            {
                this.addBtnText = "添加";
            }
            ...
            if (model == null)
            {
                ...
                if (base.Request.QueryString.ToString().Contains("AppFrame"))
                {
                    base.Response.Redirect("AppInfo.aspx?msgType=error", true);
                }
                else
                {
                    base.Response.Redirect("../AppFrame/AppInfo.aspx?msgType=error", true);
                }
            }
            ...
            if (this.sindex == "")
            {
                ...
                foreach (FieldInfo fieldInfoA in modelListDisp)
                {
                    ...
                    fieldNameCn[5] = (fieldInfoA.ColumnRender.Trim() == "" ? "false" : (fieldInfo == null ? "false" : fieldInfo.ColumnRender.Trim()));
