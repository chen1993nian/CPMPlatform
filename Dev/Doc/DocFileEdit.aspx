<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocFileEdit.aspx.cs" Inherits="Studio.JZY.Doc.DocFileEdit" %>
...
<body class="bgbody">
    ...
    <tr>
        ...
        <td colspan="3">
            <asp:TextBox ID="TextBox1" runat="server" Width="440" CssClass="TextArea green" TextMode="MultiLine" Rows="2"></asp:TextBox></td>
    </tr>

            <tr>
            <td>权限设置：</td>
            <td colspan="3">
                <div style="height:180px;width:444px;overflow:auto;background-color:White;border-bottom:1px dashed #ccc;">
