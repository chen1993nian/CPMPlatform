<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyDocTree.aspx.cs" Inherits="Studio.JZY.Doc.MyDocTree" %>
    ...
    <script type="text/javascript">
        ...
        function nodeClick(e,treeId,node)
        {
            if(node.id=="myFavorite")
            {
                ...
                window.open("DocShareFrame.aspx?time=" + Math.random(), "main");                        
            }
            else{
                window.open("MyDocList.aspx?folderId=" + node.id + "&time=" + Math.random(), "main");            
            }
        }
