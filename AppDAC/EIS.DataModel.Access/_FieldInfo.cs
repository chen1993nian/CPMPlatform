...
namespace EIS.DataModel.Access
{
	public class _FieldInfo
	{
		...
		public _FieldInfo(DbTransaction tran)
		{
		...
		public List<FieldInfo> GetFieldsStyleMerged(string tblName, int styleIndex)
		{
			...
			fieldStyles = (this.dbTransaction_0 == null ? (new _FieldStyle()).GetFieldsStyle(tblName, styleIndex) : (new _FieldStyle(this.dbTransaction_0)).GetFieldsStyle(tblName, styleIndex));
